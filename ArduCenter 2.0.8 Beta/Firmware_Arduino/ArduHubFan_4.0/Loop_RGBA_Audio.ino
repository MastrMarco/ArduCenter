...
int Audio_decay_check[] = { 0, 0, 0, 0, 0, 0, 0, 0, 0 };
long Audio_pre_react[] = { 0, 0, 0, 0, 0, 0, 0, 0, 0 };
long Audio_react[] = { 0, 0, 0, 0, 0, 0, 0, 0, 0 };
...
void RGB_Musica() {
  ...
  if (TimerVirtuale[1] >= (ResetTimerVirtuale[8] + DelayVirtuale[8])) {
...

    {
      ...
      Audio_pre_react[0] = ((long)NUM_LEDS_OUT_1 * (long)audio_input) / 1023L;
      Audio_pre_react[1] = ((long)NUM_LEDS_OUT_2 * (long)audio_input) / 1023L;
      Audio_pre_react[2] = ((long)NUM_LEDS_OUT_3 * (long)audio_input) / 1023L;
      Audio_pre_react[3] = ((long)NUM_LEDS_OUT_4 * (long)audio_input) / 1023L;
      Audio_pre_react[4] = ((long)NUM_LEDS_OUT_5 * (long)audio_input) / 1023L;
      Audio_pre_react[5] = ((long)NUM_LEDS_OUT_6 * (long)audio_input) / 1023L;
      Audio_pre_react[6] = ((long)NUM_LEDS_OUT_7 * (long)audio_input) / 1023L;
      Audio_pre_react[7] = ((long)NUM_LEDS_OUT_8 * (long)audio_input) / 1023L;
      Audio_pre_react[8] = ((long)NUM_LEDS_OUT_9 * (long)audio_input) / 1023L;
