...
void RGB_Musica() {
  ...
  for (int J = NUM_LEDS_OUT[10] - 1; J >= 0; J--) {
    if (J < Audio_react[9]) {
      ...
      Strip[2].setPixelColor(J, Strip[2].gamma32(Strip[2].ColorHSV(pixelHue_10)));
    } else {
      Strip[2].setPixelColor(J, 0, 0, 0);
    }
  }
  //**/11
  for (int K = NUM_LEDS_OUT[11] - 1; K >= 0; K--) {
    if (K < Audio_react[10]) {
      ...
      Strip[2].setPixelColor(K + NUM_LEDS_OUT[10], Strip[2].gamma32(Strip[2].ColorHSV(pixelHue_11)));
    } else {
      Strip[2].setPixelColor(K + NUM_LEDS_OUT[10], 0, 0, 0);
    }
  }
  //**/12
  for (int L = NUM_LEDS_OUT[12] - 1; L >= 0; L--) {
    if (L < Audio_react[11]) {
      ...
      Strip[2].setPixelColor(L + NUM_LEDS_OUT[10] + NUM_LEDS_OUT[11], Strip[2].gamma32(Strip[2].ColorHSV(pixelHue_12)));
    } else {
      Strip[2].setPixelColor(L + NUM_LEDS_OUT[10] + NUM_LEDS_OUT[11], 0, 0, 0);
    }
  }
}
