void loop() {
  ...
  if (TimerVirtuale[1] >= (ResetTimerVirtuale[10] + DelayVirtuale[10])) {
    ...
    if (Aniamzione_Avvio == false and (S_Pro_5V == false or Debug != 0)) {
      ...
      Strip1.show();
      Strip2.show();
      Strip3.show();  //Strip4.show(); Strip5.show(); Strip6.show(); Strip7.show(); Strip8.show(); Strip9.show();
  ...
  if (TimerVirtuale[1] >= (ResetTimerVirtuale[1] + DelayVirtuale[1])) {
    ...
    if (VerificaUSB >= 50) {
      ...
      //      Strip4.show(); Strip4.setBrightness(BRIGHTNESS);
      //
      //      Strip5.show(); Strip5.setBrightness(BRIGHTNESS);
      //      Strip6.show(); Strip6.setBrightness(BRIGHTNESS);
      //      Strip7.show(); Strip7.setBrightness(BRIGHTNESS);
      //
      //      Strip8.show(); Strip8.setBrightness(BRIGHTNESS);
      //      Strip9.show(); Strip9.setBrightness(BRIGHTNESS);
    }
  }
  //-------------------------------------
