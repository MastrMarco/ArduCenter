//*****************************************************************************************************************************//
//-------------------          By  MastrMarco    Versione 1.02       ISCRIVITI AL CANALE YOUTUBE       ------------------------//
//
//                                 Per Arduino Nano ATMega 328P NEW / OLD Boot loader
//
//                                              ArduHubFan 4.0 08/03/23
//
...
float Versione = 1.02;  // Versione Software |
//
...
byte ROM_Dati = false;  // 0 = False / 1 = True / 2 = Ripristino
