Public Class P_Impostazioni_HUB
    Dim Classe_Impostazioni_HUB_LED As New C_Impostazioni_LED_HUB
    ...
    Public Sub DataImpostazioni()
        ...
        If F_Avvio.DatiRX_1(0) >= 5 And F_Avvio.DatiRX_1(0) <= 35 Then
            StatoTempSens = 1
        Else
            StatoTempSens = 0
        End If
        ...
        If StatoTempSens = 0 And StatoTensione = 1 And StatoPowerLimit = 1 Then
            ...
            ResetErrorIMG()
            F_Connessione.PictureBoxER_Temp.Visible = True
        End If
    ...
    Private Sub ResetErrorIMG()
        F_Connessione.PictureBoxER_Temp.Visible = False
    ...
    Private Sub BtnROM_Click(sender As Object, e As EventArgs) Handles BtnROM.Click
        If F_Avvio.DatiRX_2(0) = 0 Then
            F_Avvio.Data10 = 1
            Classe_Impostazioni_HUB_LED.DataEEPROM_Save = F_Avvio.Data10
